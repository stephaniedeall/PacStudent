...
{
    public GameObject[] tilePrefabs; // Assign in Inspector (0-8 prefabs)
    public float tileSize = 1f;      // Adjust if sprites aren’t aligned
    ...
    void BuildFullLevel()
    {
        ...
        // Loop through the original top-left quadrant
